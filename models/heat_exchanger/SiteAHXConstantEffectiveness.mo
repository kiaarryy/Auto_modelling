model SiteAHXConstantEffectiveness
...
annotation(
  ...
  Documentation(info="<html><p>Site A water-water heat exchanger wrapper using Buildings.Fluid.HeatExchangers.ConstantEffectiveness. Table inputs are measured inlet temperatures and measured mass flows only; measured outlet temperatures are echoed only for scoring outputs.</p></html>"));
end SiteAHXConstantEffectiveness;
